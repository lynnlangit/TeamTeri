...
* **DEMO** Athena for Genomics -- https://aws.amazon.com/blogs/big-data/interactive-analysis-of-genomic-datasets-using-amazon-athena/
* **EC2 Cluster Controller** service AWS Batch -- https://aws.amazon.com/batch/
